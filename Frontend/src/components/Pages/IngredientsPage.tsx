...
import { AddIngredientDialog, IngredientWarrningDialog, UpdateIngredientDialog} from "@/components/Widgets/IngredientDialog";
...
export default function IngredientsPage() {
  ...
  const [warrningCount, setWarrningCount] = useState(0);
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        setWarrningCount(
          await IngredientsApi.GetIngredientsWarningCount()
        );
    ...
    {/* Header */}
      ...
      <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex gap-5">
          <IngredientWarrningDialog warrningCount={warrningCount}/>
