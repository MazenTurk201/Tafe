...
export default function Register({ onSubmit, onSignIn }: RegisterProps) {
        ...
        <div className="register-card">
          <div className="brand">
            ...
            <div className="brand-text">
              ...
              <p>Set up your account to manage your cafe with ease.</p>
            </div>
          </div>
          ...
          <form className="register-form" onSubmit={handleSubmit} noValidate>
            ...
            {errors.agreeToTerms && (
              <span id="terms-error" className="field-error terms-error">
                {errors.agreeToTerms}
              </span>
            )}
